...
-- Table `inTouch`.`User`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`User` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`PendingFriendship` ;
...
-- Table `inTouch`.`Group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`Group` ;
...
-- Table `inTouch`.`Post`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`Post` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`Membership` ;
...
-- -----------------------------------------------------
-- Table `inTouch`.`Friendhip`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`Friendhip` ;

CREATE TABLE IF NOT EXISTS `inTouch`.`Friendhip` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `inTouch`.`PendingMembership` ;
